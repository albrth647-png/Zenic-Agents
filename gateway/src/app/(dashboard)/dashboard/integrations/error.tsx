...
export default function IntegrationsError({
  ...
  useEffect(() => {
    if (process.env.NODE_ENV === "development") {
      console.error("[Integraciones Error]", error);
    }
  }, [error]);
    ...
    <div className="flex items-center justify-center py-20 px-6">
      <div className="text-center space-y-5 max-w-md">
        ...
        <div className="space-y-2">
          <h2 className="text-lg font-bold text-foreground">Error en Integraciones</h2>
          <p className="text-sm text-muted-foreground">
            No se pudieron cargar las integraciones. Intenta de nuevo.
          </p>
