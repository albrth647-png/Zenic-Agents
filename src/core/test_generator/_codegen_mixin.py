...
from ._helpers import generate_edge_case_args, generate_test_args
...
class CodeGenMixin:
    ...
    def _generate_class_tests(self, cls_info: dict, module_name: str) -> str:
        ...
        for method in cls_info["methods"]:
            ...
            method_tests = self._generate_method_tests(cls_name, fixture_name, method)
            lines.extend(method_tests)

        return "\n".join(lines)

    def _generate_method_tests(self, cls_name: str, fixture_name: str, method: dict) -> list[str]:
