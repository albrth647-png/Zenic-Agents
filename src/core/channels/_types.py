...
class ChannelMessage:
    ...
    def __post_init__(self) -> None:
        ...
        if not self.text and not self.html and not self.file_url and not self.voice_url:
            object.__setattr__(self, "text", " ")  # Ensure non-empty

    @property
    def has_voice(self) -> bool:
        """Check if this message carries voice/audio content."""
        return bool(self.voice_url)

    @property
    def has_transcription(self) -> bool:
        """Check if this message has been transcribed."""
