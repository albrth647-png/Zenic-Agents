"""
Rollback data models: enums, dataclasses, and constants.
"""
...
__all__ = ["_MAX_RETRIES", "_RETRY_DELAY", "CompensationAction", "RollbackRecord", "RollbackStatus", "RollbackTrigger"]
