//! Orchestrator catalog, executor, policy, workflow, and execution methods.
...
use zenic_runtime::{NodeExecutor, NodeExecutorRegistry};
...
impl Orchestrator {
    ...
    pub fn execute_workflow(
        ...
        // registry with the DagStepExecutor via Arc<RwLock<>>.
