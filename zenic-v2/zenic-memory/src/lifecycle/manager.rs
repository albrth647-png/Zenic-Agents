...
impl LifecycleManager {
    ...
    pub fn start_episode(&mut self, mapping: SemanticMapping) -> Result<&LifecycleEpisode, MemoryError> {
        ...
        self.episodes.last().ok_or_else(|| MemoryError::Internal("no episode after push".into()))
    }
