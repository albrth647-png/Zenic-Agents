...
//! HMAC-SHA256 signing, integrity verification, and integration with the
...
//! 4. HMAC-SHA256 signature generation over canonical serialized form
...
//! - **integrity**: SHA-256 hash of canonical form + HMAC-SHA256 signature
...
//! - HMAC-SHA256 signing uses the existing license module's primitives
