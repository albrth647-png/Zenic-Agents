...
///
/// Uses HMAC-SHA256 signing from the license module to
...
/// private_key : str
///     The HMAC secret key in hex format.
///
/// Returns
/// -------
/// CertifiedBlueprint
...
pub fn certifier_sign(
    ...
    let audit_chain = vec![
        ...
        CertificationAuditEntry {
            ...
            timestamp: certified_at.clone(),
            hash: content_hash.clone(),
            details: "HMAC-SHA256 signature applied".to_string(),
        },
    ];
...
/// Verify a CertifiedBlueprint's HMAC-SHA256 signature.
///
/// Parameters
/// ----------
...
/// public_key : str
///     The HMAC secret key in hex format (same key used for signing).
///
/// Returns
/// -------
/// bool
