...
_PLAN_TEMPLATES: dict[str, list[dict[str, Any]]] = {
    "reduce_overdue_invoices": [
        ...
        },
        {
            ...
            "action_type": "email",
            "action_config": {"template": "payment_reminder", "recipients": "overdue_clients"},
        ...
        },
        {
            ...
            "action_config": {"channel": "manager_alert", "template": "escalation_notice"},
        ...
        },
        {
            ...
            "action_type": "database",
            "action_config": {"operation": "query", "query": "SELECT * FROM overdue_report_view"},
    ...
    "reduce_no_shows": [
        {
            ...
            "action_type": "database",
            "action_config": {"operation": "query", "query": "SELECT no_show_rate FROM appointment_stats"},
            "depends_on": [],
            "estimated_impact": 0.2,
            "risk_level": "low",
        },
        {
            ...
            "action_type": "notification",
            "action_config": {"channel": "sms_email", "template": "appointment_reminder"},
        ...
        },
        {
            ...
            "action_type": "database",
            "action_config": {"operation": "query", "query": "SELECT * FROM no_show_tracking"},
    ...
    "reduce_stockouts": [
        {
            ...
            "action_type": "database",
            "action_config": {"operation": "query", "query": "SELECT * FROM inventory WHERE quantity < reorder_point"},
            "depends_on": [],
            "estimated_impact": 0.2,
            "risk_level": "low",
        },
        {
            ...
            "action_type": "notification",
            "action_config": {"channel": "supplier_api", "template": "reorder_request"},
        ...
        },
        {
            ...
            "action_type": "email",
            "action_config": {"template": "supplier_order", "recipients": "supplier_contacts"},
    ...
    "increase_revenue": [
        {
            ...
            "action_type": "database",
            "action_config": {"operation": "query", "query": "SELECT * FROM revenue_dashboard"},
            "depends_on": [],
            "estimated_impact": 0.15,
            "risk_level": "low",
        },
        {
            ...
            "action_type": "database",
            "action_config": {"operation": "query", "query": "SELECT * FROM sales_opportunities WHERE score > 0.7"},
        ...
        },
        {
            ...
            "action_type": "email",
            "action_config": {"template": "marketing_campaign", "recipients": "target_segment"},
        ...
        },
        {
            ...
            "action_type": "database",
            "action_config": {"operation": "query", "query": "SELECT * FROM campaign_performance"},
...
_GENERIC_PLAN_TEMPLATE: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "action_type": "notification",
        "action_config": {"channel": "manager_alert", "template": "threshold_alert"},
    ...
    },
    {
        ...
        "action_type": "database",
        "action_config": {"operation": "insert"},
