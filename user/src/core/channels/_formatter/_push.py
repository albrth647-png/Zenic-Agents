...
def format_push_payload(message: ChannelMessage) -> Dict[str, Any]:  # TODO: verify import
    ...
    body = sanitize_plain_text(message.text)  # TODO: verify import
    if len(body) > 200:
        body = body[:197] + "..."

    payload: Dict[str, Any] = {  # TODO: verify import
        "title": title,
        "body": body,
    }
...
def format_push_confirmation_payload(request: ConfirmationRequest) -> Dict[str, Any]:  # TODO: verify import
    ...
    return {
        "title": request.title,
        "body": sanitize_plain_text(request.message)[:200],  # TODO: Phase3 - verify import
        "actions": actions,
        "data": {
