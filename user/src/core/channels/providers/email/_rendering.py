"""
Email Channel Provider — HTML/text rendering helpers for fields tables
...
def build_confirmation_html(request: ConfirmationRequest) -> str:
...
def build_confirmation_text(request: ConfirmationRequest) -> str:
