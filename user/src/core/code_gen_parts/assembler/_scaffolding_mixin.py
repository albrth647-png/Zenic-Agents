...
class AssemblerScaffoldingMixin:
    ...
    def _generate_pydantic_models(self, entities: list[dict], project_name: str) -> str:
    ...
    def _generate_main(self, project_name: str, blocks: list[str], entities: list[dict]) -> str:
        ...
        if entities:
            import_lines.append(
                "from models import "
                + ", ".join(
                    self._block_to_class(e.get("name", "Item"))
                    + "Create, "
                    + self._block_to_class(e.get("name", "Item"))
                    + "Response"
                    for e in entities
