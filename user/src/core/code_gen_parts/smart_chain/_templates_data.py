"""SmartPromptChain - Template Fallback Data Mixin.

Provides _fallback_class_def and _fallback_method methods for
...
class SmartChainTemplatesDataMixin:
    """Mixin providing template-based fallback class and method generation."""
