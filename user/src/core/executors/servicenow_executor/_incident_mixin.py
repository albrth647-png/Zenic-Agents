"""
ZENIC-AGENTS - ServiceNow Executor: Incident Operations Mixin

Contains all incident-related operation methods:
_create_incident, _update_incident, _close_incident,
_get_incident, _search_incidents.
"""
...
class _IncidentOpsMixin:
    """Mixin for ServiceNow incident operation methods."""
