...
class ConditionalBlock(LogicBlock):
    ...
    def execute(self, data: dict[str, Any], context: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            expected_value = data.get("value", data.get("_condition_value"))
            if not field_name:
            ...
            return {"success": False, "error": f"ConditionalBlock: {e!s}"}
...
class LoopBlock(LogicBlock):
    ...
    def execute(self, data: dict[str, Any], context: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            return {"success": False, "error": f"LoopBlock: {e!s}"}
...
class ParallelBlock(LogicBlock):
    ...
    def execute(self, data: dict[str, Any], context: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            return {"success": False, "error": f"ParallelBlock: {e!s}"}
...
class SwitchBlock(LogicBlock):
    ...
    def execute(self, data: dict[str, Any], context: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            default_chain = data.get("_default_chain")
            ...
            return {"success": False, "error": f"SwitchBlock: {e!s}"}
...
class TryCatchBlock(LogicBlock):
    ...
    def execute(self, data: dict[str, Any], context: dict[str, Any]) -> dict[str, Any]:
        ...
        catch_chain = data.get("_catch_chain")
        finally_chain = data.get("_finally_chain")
