...
def build_keyword_map() -> dict[str, list[str]]:
    ...
    return {
        ...
        "invoice": ["invoice_calculator"],
        "bill": ["invoice_calculator"],
        "tax": ["invoice_calculator"],
        "discount": ["invoice_calculator"],
        "calculate": ["invoice_calculator"],
        "inventory": ["inventory_tracker"],
        "stock": ["inventory_tracker"],
        "warehouse": ["inventory_tracker"],
        "crm": ["crm_pipeline"],
        "lead": ["crm_pipeline"],
        "sales": ["crm_pipeline"],
        ...
        "signup": ["auth_register"],
        "verify": ["auth_verify"],
        "token": ["auth_verify"],
        "jwt": ["auth_verify"],
        "permission": ["auth_rbac"],
        "role": ["auth_rbac"],
        "access": ["auth_rbac"],
        "rbac": ["auth_rbac"],
        "authorize": ["auth_rbac"],
