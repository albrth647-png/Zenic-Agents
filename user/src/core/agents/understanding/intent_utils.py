...
Shared constants and utility functions for intent classification.

Migrated from agents/intent_shared.py (legacy v16) to agents/understanding/
as part of the v1->v2 migration. This is the canonical location.
...
def infer_criticality(operation: str, goal: str, target: str = "") -> str:
    """
    Infer criticality based on operation, goal, and target.
...
def infer_template_type(operation: str, description: str = "") -> str:
    """
    Infer the template type based on operation and description.
