...
Provides: forensic_hash, chain_hash, verify_merkle_chain,
          merkle_proof, batch_verify_chains
"""
...
def forensic_hash(
    ...
    if HAS_NATIVE:
        from ._loader import _rust_forensic_hash
...
def chain_hash(parent_hash: str, entry_hash: str) -> str:
    ...
    if HAS_NATIVE:
        from ._loader import _rust_chain_hash
