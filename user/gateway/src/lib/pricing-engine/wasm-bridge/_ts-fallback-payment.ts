// ─── WASM Bridge — TypeScript Fallback (Payment & Subscription) ──────────────
// Mirrors the EXACT same logic as the Rust engine for payment, subscription,
// and address validation. Used when WASM is unavailable.
