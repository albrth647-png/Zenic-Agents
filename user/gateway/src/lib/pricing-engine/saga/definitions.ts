// ─── Zenic-Agents v3 — Saga Definitions ─────────────────────────────────
// USDT TRC20 ONLY. Saga step definitions, validation functions, and
// proration calculations. Mirrors the Rust engine definitions exactly.
...
const definitions: Record<string, SagaStepDefinition[]> = {
  trial_creation: [
...
export function getSagaTypes(): Array<{ id: string; display_name: string; description: string }> {
  return [
    { id: "trial_creation", display_name: "Trial Creation Saga", description: sagaDescriptions.trial_creation },
    { id: "trial_conversion", display_name: "Trial → Paid Conversion Saga", description: sagaDescriptions.trial_conversion },
    { id: "payment_verification", display_name: "Payment Verification Saga", description: sagaDescriptions.payment_verification },
    { id: "cancellation", display_name: "Subscription Cancellation Saga", description: sagaDescriptions.cancellation },
    { id: "renewal", display_name: "Subscription Renewal Saga", description: sagaDescriptions.renewal },
    { id: "upgrade", display_name: "Tier Upgrade Saga", description: sagaDescriptions.upgrade },
    { id: "downgrade", display_name: "Tier Downgrade Saga", description: sagaDescriptions.downgrade },
    { id: "reactivation", display_name: "Subscription Reactivation Saga", description: sagaDescriptions.reactivation },
  ];
}
 ...
 */
export function getSagaDefinition(sagaType: SagaTypeName): SagaDefinition | null {
...
// ═══════════════════════════════════════════════════════════════════════════
// Validation & Calculation Functions (WASM-first, TS fallback)
// ═══════════════════════════════════════════════════════════════════════════
